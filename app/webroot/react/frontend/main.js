...
var HttpClient=function(){this.xhr=null;this.data=null;this.url=null;this.dataType=null;this.type=null;this.doneCallback=null;this.errorCallback=null;this.alwaysCallback=null;this.response=null;this.error=false;this.postJson=function(url,data,callbacks){this.data=data;this.url=url;this.type='POST';this.dataType='json';if(typeof callbacks.error!=='undefined'){this.errorCallback=callbacks.error;}if(typeof callbacks.done!=='undefined'){this.doneCallback=callbacks.done;}if(typeof callbacks.always!=='undefined'){this.alwaysCallback=callbacks.always;}this.request(data);};this.getJson=function(url,callbacks){this.data=[];this.url=url;this.type='GET';this.dataType='json';if(typeof callbacks.error!=='undefined'){this.errorCallback=callbacks.error;}if(typeof callbacks.done!=='undefined'){this.doneCallback=callbacks.done;}if(typeof callbacks.always!=='undefined'){this.alwaysCallback=callbacks.always;}this.request();};this.getResponse=function(){return response;};this.abort=function(){if(this.xhr!==null){this.xhr.abort();}};this.request=function(){var xhr=new XMLHttpRequest();var self=this;this.error=true;xhr.open(this.type,encodeURI(this.url));xhr.onload=function(){if(this.status===200){var data=self.getRequestData();self.response=data;self.error=false;}var error=self.hasError();if(error!==false){if(self.errorCallback!==null){self.errorCallback(xhr,xhr.statusText,error);}}else {if(self.doneCallback!==null){self.doneCallback(self.response);}}if(self.alwaysCallback!==null){self.alwaysCallback();}};this.xhr=xhr;if(this.type==='POST'){xhr.setRequestHeader("Content-type","application/x-www-form-urlencoded");xhr.send(this.getPostData());}else {xhr.send();}};this.getPostData=function(){var data='';for(var field in this.data){var value=this.data[field];data+=field+"="+value+"&";}return data.substr(0,data.length-1);};this.getRequestData=function(){var data;switch(this.dataType){case 'json':data=this.jsonParse(this.xhr.responseText);break;default:data=this.xhr.responseText;break;}return data;};this.jsonParse=function(json){try{return JSON.parse(json);}catch(e){this.error=e;return null;}};this.hasError=function(){return this.error;};};module.exports=HttpClient;
...
},{"../node_modules/html5-history-api/history.js":26,"./modules.js":18}],5:[function(require,module,exports){
var States={empty:0,done:1,loading:2};var Messages={positive_3:'Extremadamente Positivo',positive_2:'Positivo',positive_1:'Neutral con tendencia a Positivo',neutral:'Totalmente Neutral',negative_1:'Neutral con tendencia a Negativo',negative_2:'Negativo',negative_3:'Extremadamente negativo'};var Tier={positive_3:50,positive_2:20,positive_1:10,neutral:0,negative_1:-10,negative_2:-20,negative_3:-50};var ScoreUI={resolv:function(score){var message=this.resolvMessage(score);return React.createElement('span',null,message);},resolvMessage:function(score){var message="Sin calificar";if(score>=Tier.positive_3){message=Messages.positive_3;}else if(score>=Tier.positive_2){message=Messages.positive_2;}else if(score>=Tier.positive_1){message=Messages.positive_1;}else if(score>=Tier.neutral){message=Messages.neutral;}else if(score>=Tier.negative_1){message=Messages.negative_1;}else if(score>=Tier.negative_2){message=Messages.negative_2;}else if(score>=Tier.negative_3){message=Messages.negative_3;}return message;}};var UI={title:function(){return React.createElement('h2',{className:'analysis-title'},'ANÁLISIS EMOCIONAL');},done:function(react){var title=UI.title();return React.createElement('div',{className:'col'},title,ScoreUI.resolv(react.state.analysis.score));},empty:function(react){var title=UI.title();return React.createElement('div',{className:'col'},title,React.createElement('span',{className:'analysis-row'},'Aún no se ha realizado el análisis'));},loading:function(react){var title=UI.title();return React.createElement('div',{className:'col'},title,React.createElement('span',null,'Obteniendo info de análisis...'));}};var EmotionalAnalysis=React.createClass({displayName:'EmotionalAnalysis',propTypes:{analysis:React.PropTypes.object.isRequired},getInitialState:function(){var state=States.done;if(this.props.analysis.score===null){state=States.empty;}return {state:state,analysis:this.props.analysis};},render:function(){var renderUI=this.resolvRenderUI();return renderUI;},loading:function(){this.setState({state:States.loading});},done:function(analysis){var state=States.done;if(analysis===null){state=States.empty;}this.setState({state:state,analysis:analysis});},resolvRenderUI:function(){var renderUI=React.createElement('div',null,' View not set yet! ');switch(this.state.state){case States.done:renderUI=UI.done(this);break;case States.empty:renderUI=UI.empty(this);break;case States.loading:renderUI=UI.loading(this);break;}return renderUI;}});module.exports=EmotionalAnalysis;
...
},{"../components/http_client.js":1,"../node_modules/html5-history-api/history.js":26,"./dispatcher.js":4}],7:[function(require,module,exports){
var Dispatcher=require('./dispatcher.js');var HTMLViewer=require('./html_viewer.js');var HtmlUrlViewer=require('./html_url_viewer.js');var HTMLStats=require('./html_stats.js');var Modules=require('./modules.js');var HttpClient=require('../components/http_client.js');var WordCountAnalysis=require('./word_count_analysis.js');var EmotionalAnalysis=require('./emotional_analysis.js');var UI={get:function(react){var target=react.props.target;var url=react.props.url;var swapper=react.swapper;var link=react.props.link;var meta=react.props.meta;var analysis=react.props.analysis;var renderUI=React.createElement('div',{id:'exploration',className:'module_wrapper'},React.createElement('h1',{className:'module_title'},target.name,React.createElement('br',null),React.createElement(HtmlUrlViewer,{ref:function(ref){react.urlViewer=ref;},url:url.full_url})),React.createElement('div',{className:'col-3-4'},React.createElement(HTMLViewer,{link:link,swapper:swapper})),React.createElement('div',{className:'col-1-4'},React.createElement(HTMLStats,{ref:function(ref){react.stats=ref;},meta:meta}),React.createElement(WordCountAnalysis,{ref:function(ref){react.analysis.wc=ref;},analysis:analysis.wc}),React.createElement(EmotionalAnalysis,{ref:function(ref){react.analysis.emo=ref;},analysis:analysis.emo})));return renderUI;}};var Exploration=React.createClass({displayName:'Exploration',request:null,urlViewer:null,stats:null,analysis:{},module:'exploration',componentWillMount:function(){Dispatcher.configure($ReactData.config);},componentWillUnmount:function(){if(this.request!==null){this.request.abort();}},propTypes:{analysis:React.PropTypes.object.isRequired,link:React.PropTypes.string.isRequired,target:React.PropTypes.object.isRequired,meta:React.PropTypes.object.isRequired,url:React.PropTypes.object.isRequired},swapper:function(hash){var params=this.getParams(hash);var module=this.getModule();var callback=this.swapperCallback.bind(this,module,params);Dispatcher.navigate(module,params,callback);},swapperCallback:function(module,params){var api=Dispatcher.resolvModuleApi(module,params);this.ajaxOnStart();if(this.request!==null){this.request.abort();}this.request=new HttpClient();this.request.getJson(api,{error:this.ajaxOnError.bind(this,module,params),done:this.ajaxOnSuccess});},ajaxOnStart:function(){this.urlViewer.loading();this.stats.loading();this.analysis.wc.loading();this.analysis.emo.loading();},ajaxOnError:function(module,params){var callback=this.swapperCallback.bind(this,module,params);this.urlViewer.error(callback);this.stats.error(callback);},ajaxOnSuccess:function(data){var url=data.url;var meta=data.meta;var analysis=data.analysis;this.urlViewer.done(url.full_url);this.stats.done(meta);this.analysis.wc.done(analysis.wc);this.analysis.emo.done(analysis.emo);},getParams:function(hash){return Modules.exploration.params(this.props.target.id,hash,this.props.target.name);},getModule:function(){return this.module;},render:function(){var renderUI=this.resolvRenderUI();return renderUI;},resolvRenderUI:function(){var renderUI=UI.get(this);return renderUI;}});module.exports=Exploration;

},{"../components/http_client.js":1,"./dispatcher.js":4,"./emotional_analysis.js":5,"./html_stats.js":13,"./html_url_viewer.js":14,"./html_viewer.js":15,"./modules.js":18,"./word_count_analysis.js":25}],8:[function(require,module,exports){
...
},{"../components/runner.js":3,"./dispatcher.js":4,"./engine.js":6,"./header.js":9,"./menu.js":17}],9:[function(require,module,exports){
...
},{"../components/links.js":2,"./dispatcher.js":4}],10:[function(require,module,exports){
...
},{"./dispatcher.js":4,"./history_item.js":10,"./history_loader.js":12,"./modules.js":18}],12:[function(require,module,exports){
...
},{"./dispatcher.js":4}],14:[function(require,module,exports){
...
},{"./dispatcher.js":4,"./html_viewer_loader.js":16}],16:[function(require,module,exports){
...
},{"./dispatcher.js":4}],17:[function(require,module,exports){
...
},{"./dispatcher.js":4,"./searcher.js":22}],18:[function(require,module,exports){
...
},{"./exploration.js":7,"./history_list.js":11,"./search.js":19,"./target_list.js":24}],19:[function(require,module,exports){
...
},{"./dispatcher.js":4,"./modules.js":18,"./search_item.js":20,"./search_loader.js":21}],20:[function(require,module,exports){
...
},{"./dispatcher.js":4,"./modules.js":18}],21:[function(require,module,exports){
...
},{"./dispatcher.js":4}],22:[function(require,module,exports){
...
},{"./dispatcher.js":4,"./modules.js":18}],24:[function(require,module,exports){
...
},{"./target_item.js":23}],25:[function(require,module,exports){
var tagCloud=require('tag-cloud');var States={empty:0,done:1,loading:2};var UI={title:function(){return React.createElement('h2',{className:'analysis-title'},'PALABRAS NOTABLES');},done:function(react){var data=react.tagCloud;var title=UI.title();var tags=[];var cloud;for(var i in react.state.analysis){var blob=react.state.analysis[i];tags.push({tagName:blob.word,count:blob.f});}tagCloud.tagCloud(tags,function(err,data){cloud={__html:data};});return React.createElement('div',{className:'col'},title,React.createElement('div',{className:'tag-cloud',dangerouslySetInnerHTML:cloud}));},empty:function(react){var title=UI.title();return React.createElement('div',{className:'col'},title,React.createElement('span',{className:'analysis-row'},'Aún no se ha realizado el análisis'));},loading:function(react){var title=UI.title();return React.createElement('div',{className:'col'},title,React.createElement('span',null,'Obteniendo info de análisis...'));}};var WordCountAnalysis=React.createClass({displayName:'WordCountAnalysis',propTypes:{analysis:React.PropTypes.array.isRequired},getInitialState:function(){var state=States.empty;if(this.props.analysis.length>0){state=States.done;}return {state:state,analysis:this.props.analysis};},render:function(){var renderUI=this.resolvRenderUI();return renderUI;},loading:function(){this.setState({state:States.loading});},done:function(analysis){var state=States.done;if(analysis.length===0){state=States.empty;}this.setState({state:state,analysis:analysis});},resolvRenderUI:function(){var renderUI=React.createElement('div',null,' View not set yet! ');switch(this.state.state){case States.done:renderUI=UI.done(this);break;case States.empty:renderUI=UI.empty(this);break;case States.loading:renderUI=UI.loading(this);break;}return renderUI;}});module.exports=WordCountAnalysis;

},{"tag-cloud":27}],26:[function(require,module,exports){
/*!
