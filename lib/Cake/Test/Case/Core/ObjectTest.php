 ...
 */
	public function testLog() {
		...
		$this->assertTrue($this->object->logcat('Test warning 1'));
		$this->assertTrue($this->object->logcat(array('Test' => 'warning 2')));
		...
		$this->assertTrue($this->object->logcat('Test warning 1', LOG_WARNING));
		$this->assertTrue($this->object->logcat(array('Test' => 'warning 2'), LOG_WARNING));
		$result = file(LOGS . 'error.log');
