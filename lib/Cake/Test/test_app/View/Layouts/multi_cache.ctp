...
<!--nocache-->
	...
	<?php $this->logcat('1. layout before content') ?>
<!--/nocache-->
<!--nocache--><?php echo $this->element('nocache/plain'); ?><!--/nocache-->
<!--nocache-->
	<p>C. Layout After Test Element But Before Content</p>
	<?php $this->logcat('3. layout after test element but before content') ?>
<!--/nocache-->
<?php echo $this->fetch('content'); ?>
<!--nocache-->
	<p>E. Layout After Content</p>
	<?php $this->logcat('5. layout after content') ?>
<!--/nocache-->
...
<!--nocache-->
	...
	<?php $this->logcat('7. layout after content and after element with no cache tags') ?>
<!--/nocache-->
